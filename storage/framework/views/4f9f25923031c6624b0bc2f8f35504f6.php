<div x-data="main(<?php echo e($fixMinus); ?>)">
    ...
    <section class="flex justify-center  pt-[20svh] min-h-[100svh]">
        ...
        <div class=" z-10 bg-white border w-[90svw] md:w-[34rem] rounded-md  h-fit ">
            <div class="card-body p-5 sm:p-10">
                <img src="<?php echo e(asset('login.png')); ?>" class="avatar w-[14rem]" alt="">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.loading-indicator','data' => ['class' => 'h-5 w-5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?></button>
    ...
    ?>
<?php /**PATH /home/loyd-deped/Desktop/www/PDS/resources/views/livewire/auth/otp.blade.php ENDPATH**/ ?>