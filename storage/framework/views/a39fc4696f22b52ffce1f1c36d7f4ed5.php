...
<?php endif; ?>
        ...
        <div class="p-8 bg-white rounded-lg">
            <?php echo e($this->addEventAction); ?>
            ...
            loadCalendar() {
                this.calendarVar = new Calendar(this.$refs.calendar, {
                    ...
                    eventContent: function(eventInfo) {
                        ...
                        const button = `<?php if (isset($component)) { $__componentOriginalf0029cce6d19fd6d472097ff06a800a1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf0029cce6d19fd6d472097ff06a800a1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.icon-button','data' => ['color' => 'success','size' => 'xs','icon' => 'heroicon-m-pencil-square','wire:click' => 'mountAction(\'editEvent\', { id: ${eventInfo.event.id} })','label' => 'Edit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'success','size' => 'xs','icon' => 'heroicon-m-pencil-square','wire:click' => 'mountAction(\'editEvent\', { id: ${eventInfo.event.id} })','label' => 'Edit']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>`
                        const buttonDelete = `<?php if (isset($component)) { $__componentOriginalf0029cce6d19fd6d472097ff06a800a1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf0029cce6d19fd6d472097ff06a800a1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.icon-button','data' => ['color' => 'danger','size' => 'xs','icon' => 'heroicon-m-trash','wire:click' => 'mountAction(\'deleteEvent\', { id: ${eventInfo.event.id} })','label' => 'Delete']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('filament::icon-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'danger','size' => 'xs','icon' => 'heroicon-m-trash','wire:click' => 'mountAction(\'deleteEvent\', { id: ${eventInfo.event.id} })','label' => 'Delete']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf0029cce6d19fd6d472097ff06a800a1)): ?>
<?php $attributes = $__attributesOriginalf0029cce6d19fd6d472097ff06a800a1; ?>
...
<?php endif; ?>`
    ...
    ?>
<?php /**PATH /home/loyd-deped/Desktop/www/PDS/resources/views/livewire/leave/personnel/calendar.blade.php ENDPATH**/ ?>