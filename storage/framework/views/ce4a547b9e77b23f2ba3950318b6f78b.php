...
<?php endif; ?>
    ...
    <div>
        ...
        <!--[if BLOCK]><![endif]--><?php if(Auth::user()->fd_code == '01D' || Auth::user()->can(\App\Enums\UserManagement\PermissionEnum::GENERATING_ID->value)): ?>
            <!-- Breadcrumb -->
...
<?php endif; ?>
    ...
    ?>
<?php /**PATH /home/loyd-deped/Desktop/www/PDS/resources/views/livewire/i-d/dashboard.blade.php ENDPATH**/ ?>