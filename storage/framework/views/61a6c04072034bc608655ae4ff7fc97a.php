...
<?php endif; ?>
     ...
     <?php $__env->endSlot(); ?>
    <div>
        <!--[if BLOCK]><![endif]--><?php if(Auth::user()->fd_code == '01D' || Auth::user()->can(\App\Enums\UserManagement\PermissionEnum::USER_MANAGEMENT->value)): ?>
            <!-- Breadcrumb -->
...
<?php endif; ?>
    ...
    ?>
<?php /**PATH /home/loyd-deped/Desktop/www/PDS/resources/views/livewire/user-management/permission.blade.php ENDPATH**/ ?>