...
<?php foreach($attributes->onlyProps(['color','disabled','form','href','icon','iconSize','keyBindings','labelSrOnly','tag','target','tooltip','type','wire:click','wire:target','xOn:click','class','id','badge','badgeColor','iconPosition','size','badgeColor','iconPosition']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['color','disabled','form','href','icon','iconSize','keyBindings','labelSrOnly','tag','target','tooltip','type','wire:click','wire:target','xOn:click','class','id','badge','badgeColor','iconPosition','size','badgeColor','iconPosition']); ?>
<?php foreach (array_filter((['color','disabled','form','href','icon','iconSize','keyBindings','labelSrOnly','tag','target','tooltip','type','wire:click','wire:target','xOn:click','class','id','badge','badgeColor','iconPosition','size','badgeColor','iconPosition']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.link','data' => ['color' => $color,'disabled' => $disabled,'form' => $form,'href' => $href,'icon' => $icon,'iconSize' => $iconSize,'keyBindings' => $keyBindings,'labelSrOnly' => $labelSrOnly,'tag' => $tag,'target' => $target,'tooltip' => $tooltip,'type' => $type,'wire:click' => $wireClick,'wire:target' => $wireTarget,'xOn:click' => $xOnClick,'class' => $class,'id' => $id,'badge' => $badge,'badgeColor' => $badgeColor,'iconPosition' => $iconPosition,'size' => $size]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH /home/loyd-deped/Desktop/www/PDS/storage/framework/views/18bb4cb2739f61c8dda8e9a7ee601d48.blade.php ENDPATH**/ ?>