                            ...
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(\Carbon\Carbon::now()->subMonth()->format('F Y') !== $leaves->current_month): ?>
                                    ...
                                    <span class="text-red-800 font-medium text-xs">
                                      Your leave points aren’t fully updated yet—as of now, I’ve only recorded up to <strong><?php echo e($leaves->current_month); ?></strong> (the latest should be <strong><?php echo e(\Carbon\Carbon::now()->format('F Y')); ?></strong>).
                                    </span>
                                </div>
