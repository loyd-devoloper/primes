                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 items-start  ">
                        <div>
                            <div class="flex items-center flex-col xl:flex-row  gap-1 ">
                                <img
                                    src="<?php echo e(!!$employeeInfo?->profile ? asset('storage/' . $employeeInfo?->profile) : asset('assets/no_image.jpg')); ?>"
                    ...
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                        ...
                        <li class="me-2">
                            <a type="button" wire:click="changeTab('LEAVE-REQUEST')"
                               ...
                               aria-current="page">
                                <svg
                                    class="w-4 h-4 me-2 <?php echo e($tab == 'LEAVE-REQUEST' ? 'text-blue-600 dark:text-blue-500' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300'); ?>"
                        ...
                        <li class="me-2">
                            <a type="button" wire:click="changeTab('UPDATE-LEAVE')"
                               class="cursor-pointer transition-all inline-flex items-center justify-center p-4  rounded-t-lg <?php echo e($tab == 'UPDATE-LEAVE' ? 'text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500' : 'border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'); ?>  group">
                                ...
                                <svg
                                    class=" me-2 size-6 <?php echo e($tab == 'UPDATE-LEAVE' ? 'text-blue-600 dark:text-blue-500' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300'); ?>"
                        ...
                        <li class="me-2">
                            <a type="button" wire:click="changeTab('LEAVE-CARD')"
                               class="cursor-pointer transition-all inline-flex items-center justify-center p-4 <?php echo e($tab == 'LEAVE-CARD' ? 'text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500' : 'border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'); ?> group">
                                <svg
                                    class="w-4 h-4 me-2 <?php echo e($tab == 'LEAVE-CARD' ? 'text-blue-600 dark:text-blue-500' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300'); ?>"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 18 20">
                                    <path
                        ...
                        <li class="me-2">
                            <a type="button" wire:click="changeTab('ACTIVITY-LOG')"
                               class="cursor-pointer transition-all inline-flex items-center justify-center p-4 <?php echo e($tab == 'ACTIVITY-LOG' ? 'text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500' : 'border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'); ?> group">
                                <svg
                                    class="w-4 h-4 me-2 <?php echo e($tab == 'ACTIVITY-LOG' ? 'text-blue-600 dark:text-blue-500' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300'); ?>"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 18 20">
                                    <path
                                        d="M16 1h-3.278A1.992 1.992 0 0 0 11 0H7a1.993 1.993 0 0 0-1.722 1H2a2 2 0 0 0-2 2v15a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2Zm-3 14H5a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2Zm0-4H5a1 1 0 0 1 0-2h8a1 1 0 1 1 0 2Zm0-5H5a1 1 0 0 1 0-2h2V2h4v2h2a1 1 0 1 1 0 2Z"/>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-actions::components.group','data' => ['actions' => [
                                ...
                                $this->slideOverLeaveCardCtoAction
                            ],'button' => true,'label' => 'Download Leave Card','icon' => 'heroicon-m-arrow-down-tray','color' => 'danger','size' => 'sm','tooltip' => 'More actions']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['actions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                                $this->slideOverLeaveCardAction,
                                $this->slideOverLeaveCardCtoAction
                            ]),'button' => true,'label' => 'Download Leave Card','icon' => 'heroicon-m-arrow-down-tray','color' => 'danger','size' => 'sm','tooltip' => 'More actions']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
