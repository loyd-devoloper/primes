        ...
        <form wire:submit.prevent='employee_login'
            ...
            <div class="card-body p-5 sm:p-10">
               <div class="flex justify-between">
                   <img src="<?php echo e(asset('login.png')); ?>" class="avatar w-[10rem] md:w-[14rem] " alt="">
                   <img src="<?php echo e(asset('assets/r4a.png')); ?>" class="avatar size-20" alt="">
               </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.input.wrapper','data' => ['class' => 'defaultInputRoundedWithIcon']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'defaultInputRoundedWithIcon']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.input.index','data' => ['type' => 'text','wire:model' => 'email','style' => 'color: black']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','wire:model' => 'email','style' => 'color: black']); ?>
...
<?php $component->withAttributes(['class' => 'defaultInputRoundedWithIcon']); ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginal9ad6b66c56a2379ee0ba04e1e358c61e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9ad6b66c56a2379ee0ba04e1e358c61e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.input.index','data' => ['type' => 'password','xRef' => 'password','wire:model' => 'password','style' => 'color: black','class' => 'grow','placeholder' => '***************']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('filament::input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'password','x-ref' => 'password','wire:model' => 'password','style' => 'color: black','class' => 'grow','placeholder' => '***************']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9ad6b66c56a2379ee0ba04e1e358c61e)): ?>
<?php $attributes = $__attributesOriginal9ad6b66c56a2379ee0ba04e1e358c61e; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.input.checkbox','data' => ['wire:model' => 'data_privacy','class' => 'data_privacy']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'data_privacy','class' => 'data_privacy']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.icon-button','data' => ['icon' => 'heroicon-m-arrow-top-right-on-square','color' => 'primary','label' => 'Data Privacy','size' => 'sm','xOn:click' => 'data_privacy = !data_privacy']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'heroicon-m-arrow-top-right-on-square','color' => 'primary','label' => 'Data Privacy','size' => 'sm','x-on:click' => 'data_privacy = !data_privacy']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['data_privacy'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?></button>
    ...
    ?>
<?php /**PATH /home/loyd-deped/Desktop/www/PDS/resources/views/livewire/auth/login.blade.php ENDPATH**/ ?>