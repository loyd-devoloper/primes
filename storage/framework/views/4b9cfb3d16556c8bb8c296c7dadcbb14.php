            ...
            <div style="border-width: 1px;border-style: solid;  border-color: black;">
                <div class="grid grid-cols-7 p-1" style="">
                    ...
                    <div class="col-span-5 " style="">
                        ...
                        <div class="flex">
                            <div class="w-1/3">
                                <p><?php echo e($getRecord()->userInfo?->lname); ?></p>
                            </div>
                            <div class="w-1/3">
                                <p><?php echo e($getRecord()->userInfo?->fname); ?></p>
                            </div>
                            <div class="w-1/3">
                                <p><?php echo e($getRecord()->userInfo?->mname); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="border border-solid border-black my-1.5">
                <div class="flex justify-between">
                    <div class="w-1/2 flex gap-2">
                        ...
                        <p><?php echo e(\Carbon\Carbon::parse($getRecord()->created_at)->format('F d, Y')); ?></p>
                    </div>
                    <div class="w-1/4 flex gap-2"">
                        <p class="font-bold">4. POSITION</p>
                        <p><?php echo e($getRecord()->workexperience?->position_title); ?></p>
                    </div>
                    <div class="w-1/4 flex gap-2"">
                        <p class="font-bold">5. SALARY</p>
                        <p> <?php echo e($getRecord()->workexperience ? 'SG ' . $getRecord()->workexperience?->salary_grade : ''); ?>
                    ...
                    <div class="w-1/2 border-r border-black pr-4">
                        ...
                        <div class="pl-4 py-4">
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::VACATION_LEAVE->value ? 'checked' : ''); ?>>
                                Vacation Leave (Sec. 51, Rule XVI, Omnibus Rules
                                Implementing E.O.
                                No. 292)</p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::FORCE_LEAVE->value ? 'checked' : ''); ?>>
                                Mandatory/Forced Leave (Sec. 25, Rule XVI, Omnibus Rules
                                Implementing
                                E.O. No. 292)</p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::SICK_LEAVE->value ? 'checked' : ''); ?>>
                                Sick Leave (Sec. 43, Rule XVI, Omnibus Rules Implementing E.O.
                                No.
                                292)</p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::MATERNITY_LEAVE->value ? 'checked' : ''); ?>>
                                Maternity Leave (R.A. No. 11210/ Implemented by CSC, DOLE and
                                SSS)
                            </p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::PATERNITY_LEAVE->value ? 'checked' : ''); ?>>
                                Paternity Leave (R.A. No. 8187/ CSC MC No. 71, s. 1998, as
                                amended)
                            </p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::SPECIAL_PRIVILEGE_LEAVE->value ? 'checked' : ''); ?>>
                                Special Privilege Leave (Sec. 21, Rule XVI, Omnibus Rules
                                Implementing E.O. No. 292)</p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::SOLO_PARENT_LEAVE->value ? 'checked' : ''); ?>>
                                Solo Parent Leave (RA No. 8972/ CSC MC No. 8, s. 2004)</p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::STUDY_LEAVE->value ? 'checked' : ''); ?>>
                                Study Leave (Sec. 68, Rule XVI, Omnibus Rules Implementing E.O.
                                No.
                                292)</p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::VAWC_LEAVE->value ? 'checked' : ''); ?>>
                                10-Day VAWC Leave (RA No. 9262/ CSC MC No. 15, s. 2005)</p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::REHABILITATION_PRIVILEGE->value ? 'checked' : ''); ?>>
                                Rehabilitation Privilege (Sec. 55, Rule XVI, Omnibus Rules
                                Implementing E.O. No. 292)</p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::SPECIAL_LEAVEL_BENIFITS_FOR_WOMEN->value ? 'checked' : ''); ?>>
                                Special Leave Benefits for Women (RA No. 9710/ CSC MC No. 25, s.
                                2010)</p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::SPECIAL_EMERGENCY_CALAMITY_LEAVE->value ? 'checked' : ''); ?>>
                                Special Emergency (Calamity) Leave (CSC MC No. 2, s. 2012, as amended)</p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::ADOPTION_LEAVE->value ? 'checked' : ''); ?>>
                                Adoption Leave (RA No. 8552)</p>
                            <p><input type="checkbox"
                                    <?php echo e($getRecord()->type_of_leave == \App\Enums\TypeOfLeaveEnum::OTHERS->value ? 'checked' : ''); ?>>
                                Others:
                        ...
                        <div class="space-y-6 px-10">
                            <div>
                                ...
                                <p class="border-b border-black text-center font-bold">
                                    <?php echo e((int) $getRecord()->days > 1 ? $getRecord()->days . ' Days' : $getRecord()->days . ' Day'); ?>

                                </p>
                                <p>INCLUSIVE DATES</p>
                            </div>
                            <p class="border-b border-black text-center font-bold"><?php echo e($inclusive_date); ?></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="">
                        ...
                        <div class="w-full py-5 mt-8 ">
                            <p class=" border-b border-black text-center relative">
                                <img src="<?php echo e(asset('storage/' . $e_sign)); ?>"
                    ...
                    <div class="w-1/2 border-r border-black pr-4">
                        ...
                        <div class="px-10 py-5 flex flex-col items-end">
                            <div class="flex">As of <div
                                    ...
                                    <?php echo e(\Carbon\Carbon::parse($getRecord()->created_at)->subMonth()->endOfMonth()->format('F d, Y')); ?>
                            ...
                            <table class="w-full border border-black mt-2">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="border border-black text-center"><?php echo e($getRecord()->vl); ?></td>
                                        <td class="border border-black text-center"><?php echo e($getRecord()->sl); ?></td>
                                    </tr>
                                    <tr>

                                        <td class="border border-black">Less this application</td>
                                        <td class="border border-black text-center">
                                            <?php echo e($getRecord()->type_of_leave == 'Vacation Leave' || $getRecord()->type_of_leave == 'Mandatory/Forced Leave' ? $getRecord()->paid_days : ''); ?>

                                        </td>
                                        <td class="border border-black text-center">
                                            <?php echo e($getRecord()->type_of_leave == 'Sick Leave' ? $getRecord()->paid_days : ''); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border border-black text-center">
                                            <?php echo e($getRecord()->type_of_leave == 'Vacation Leave' || $getRecord()->type_of_leave == 'Mandatory/Forced Leave' ? (float) $getRecord()->vl - (float) $getRecord()->paid_days : $getRecord()->vl); ?>

                                        </td>
                                        <td class="border border-black text-center">
                                            <?php echo e($getRecord()->type_of_leave == 'Sick Leave' ? (float) $getRecord()->sl - (float) $getRecord()->paid_days : $getRecord()->sl); ?>
                            ...
                            <div class="mt-10 w-full relative">
                                <!--[if BLOCK]><![endif]--><?php if($getRecord()->chiefInfo?->leavePointLatest?->e_sign && $getRecord()->location == 'Records' && $getRecord()->type_of_process == 'ELECTRONIC SIGNATURE'): ?>
                                    <img src="<?php echo e(asset('storage/' . $getRecord()->chiefInfo?->leavePointLatest?->e_sign)); ?>"
                                        class="absolute -top-[6rem] left-1/2 transform -translate-x-1/2  w-[10rem] h-[10rem] "
                                        alt="">
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <p class="text-center font-bold"><?php echo e($getRecord()->chiefInfo?->name); ?></p>
                                <p class="text-center w-full border-t border-solid border-black">
                                    <?php echo e($getRecord()->chief_type); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class=" w-1/2 pl-4">
                        ...
                        <div class="p-10">
                            ...
                            <div class="relative">
                                <!--[if BLOCK]><![endif]--><?php if(
                                    ...
                                    <img src="<?php echo e(asset('storage/' . $getRecord()->headInfo?->leavePointLatest?->e_sign)); ?>"
                                        class="absolute -top-[6rem] left-1/2 transform -translate-x-1/2  w-[10rem] h-[10rem] "
                                        alt="">
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                                <div class="border-b border-black font-bold  mt-9 text-center">
                                    <?php echo e($getRecord()->headInfo?->name); ?></div>
                ...
                <div class="border-b border-x border-black p-4 w-full ">
                    ...
                    <div class="flex justify-center items-center mt-20">
                        <div class="text-center relative">
                            <?php if($getRecord()->rdInfo?->leavePointLatest?->e_sign && $getRecord()->location == 'Records' && $getRecord()->type_of_process == 'ELECTRONIC SIGNATURE'): ?>
                                <img src="<?php echo e(asset('storage/' . $getRecord()->rdInfo?->leavePointLatest?->e_sign)); ?>"
                                    class="absolute -top-[6rem] left-1/2 transform -translate-x-1/2  w-[10rem] h-[10rem] "
                                    alt="">
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <p class="font-bold border-b border-black w-[24rem]"><?php echo e($getRecord()->rdInfo?->name); ?></p>
                            <p><?php echo e($getRecord()->rd_type); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/loyd-deped/Desktop/www/PDS/resources/views/livewire/leave/asset/previewForm6.blade.php ENDPATH**/ ?>