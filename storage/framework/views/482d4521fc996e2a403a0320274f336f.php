...
<?php endif; ?>
     ...
     <?php $__env->endSlot(); ?>
    <div>
        <!--[if BLOCK]><![endif]--><?php if(Auth::user()->fd_code == '01D' || Auth::user()->can('USER MANAGEMENT')): ?>
            <!-- Breadcrumb -->
...
<?php endif; ?>
    ...
    ?>
<?php /**PATH /home/loyd-deped/Desktop/www/PDS/resources/views/livewire/task-table.blade.php ENDPATH**/ ?>