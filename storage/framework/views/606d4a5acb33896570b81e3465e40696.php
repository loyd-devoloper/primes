        ...
        <div id="table" class="block w-fit  overflow-x-auto   mx-auto text-xs relative ">
            ...
            <div class=" ">
                ...
                <div x-data="{ employee: <?php echo \Illuminate\Support\Js::from($this->dtrArrView)->toHtml() ?> }" class=" max-w-[29rem]  h-full pt-10">
                    <table class="border-collapse w-full ">
                        <tr class="">
                            ...
                            <td class="border-y border-r border-black border-solid px-2.5 text-center" colspan="2">
                                A.M.</td>
                            <td class="border-y border-r border-black border-solid px-2.5 text-center" colspan="2">
                                P.M.</td>
                            <td class="border-y border-r border-black border-solid px-2.5 text-center" colspan="2">
                ...
                <div class="max-w-[29rem] ">
                    <p class="pb-12 pt-5">I certify on my honor that the above is a true and correct report of the hours
                        of work performed, record of which was made daily at the time of arrival and departure from
                        office.</p>
