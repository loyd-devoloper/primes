<div  x-data="skillDisplays(<?php echo \Illuminate\Support\Js::from($getRecord())->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($this->applicationOfEducationWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category))->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($this->outstandingAccomplishmentWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category))->toHtml() ?>)" id="psbtablegrade" class="relative overflow-x-auto shadow-md sm:rounded-lg  " wire:ignore>
...
<?php $component->withAttributes(['field' => $field]); ?>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 relative  ">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-600 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <?php echo e($this->educationWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category)); ?>
                ...
                <tr class="border-b border-gray-600 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <?php echo e($this->trainingWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category)); ?>
                ...
                <tr class="border-b border-gray-600 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <?php echo e($this->experienceWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category)); ?>
                ...
                <tr class="border-b border-gray-600 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <?php echo e($this->performanceWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category)); ?>
                ...
                <?php echo $__env->make(
                    'livewire.recruitment.assets.' .
                        ...
                        '_' .
                        $getRecord()->jobOtherInformation?->category, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <tr class="border-b border-gray-600 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <?php echo e($this->potentialWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category)); ?>
                    ...
                    <td class="px-2 py-4 bg-gray-50 dark:bg-gray-800">
                        ...
                        <div class="grid">
                            <label for=""> WE =
                                <?php echo e($this->partialPotentialWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category, 'we')); ?>

                                pts.</label>
                            <input type="number"
                                max="<?php echo e($this->partialPotentialWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category, 'we')); ?>"
                                class="w-full  !max-w-[12rem]" x-model="we" step="any" />
                        </div>
                        <div class="grid">
                            <label for="">S/WST =
                                <?php echo e($this->partialPotentialWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category, 'wst')); ?>

                                pts.</label>
                            <input type="number"
                                max="<?php echo e($this->partialPotentialWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category, 'wst')); ?>"
                                class="  !max-w-[12rem]" x-model="wst" step="any" />
                        </div>

                        <div class="grid">
                            <label for="">BEI -
                                <?php echo e($this->partialPotentialWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category, 'bei')); ?>

                                pts.</label>
                            <input type="number"
                                max="<?php echo e($this->partialPotentialWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category, 'bei')); ?>"
        ...
        <div class="py-5 px-3">
            ...
            <!--[if BLOCK]><![endif]--><?php if(Auth::user()->fd_code == '01D' || Auth::user()->can(\App\Enums\UserManagement\PermissionEnum::PSB_GRADE_BULK->value)): ?>
...
<?php endif; ?>
    ...
    ?>
<?php /**PATH /home/loyd-deped/Desktop/www/PDS/resources/views/livewire/recruitment/assets/psb_grading.blade.php ENDPATH**/ ?>