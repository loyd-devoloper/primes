<div>
    <nav x-data="{ lists: JSON.stringify(<?php echo \Illuminate\Support\Js::from($list)->toHtml() ?>) }"
    ...
    <ol class="inline-flex flex-wrap items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        <li class="inline-flex items-center">
            <a href="<?php echo e(route('personnel.home')); ?>"
...
<?php /**PATH /home/loyd-deped/Desktop/www/PDS/resources/views/components/bread-crumb.blade.php ENDPATH**/ ?>