...
<tr class="border-b border-gray-600 dark:border-gray-700">
    <th
        class="px-6 py-4 text-xs font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
        a. Awards <br> and Recognition(2 pts.)
    </th>
    <td class="px-6 py-4">
        <?php echo e($this->outstandingAccomplishmentWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category)); ?>
...
<tr class="border-b border-gray-600 dark:border-gray-700">
    <th
        class="px-6 py-4 text-xs font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
        b. Research <br> and Innovation(5 pts.)
    </th>
    <td class="px-6 py-4">
    ...
    <td class="px-2 py-4 bg-gray-50 dark:bg-gray-800" x-data="{ open: false }">
        ...
        <p class="max-w-[12rem] text-black" x-show="open">
            <strong>Means of verification:</strong>
            <br>
            A. Proposal duly approved by the Head of Office or the designated
Research Committee per DO No. 16, s. 2017
            <br>
            ...
            <br>
            <br>
            For collaborative research studies/innovation, the total points shall be divided by the number of authors/researchers indicated in the copyright page.
        </p>
        <div class="grid">
            <label>Remarks</label>
...
<tr class="border-b border-gray-600 dark:border-gray-700">
    ...
    <td class="px-2 py-4 bg-gray-50 dark:bg-gray-800" x-data="{ open: false }">
        ...
        <p class="max-w-[12rem] text-black " x-show="open">
            ...
            <tr>
                <td class="border border-black ">Organizational Level Speakership or Higher - 2 points</td>
                <td class="border border-black ">National Level Speakership or Higher - 2 points</td>
                <td class="border border-black ">National Level Speakership or Higher - 2 points</td>
                <td class="border border-black ">Regional Level Speakership or Higher -2 points</td>
                <td class="border border-black ">Division Level Speakership or Higher - 2 points</td>
            </tr>
            <tr>
                <td class="border border-black ">Local Office Level Speakership - 1 point</td>
                <td class="border border-black ">Central Office Level Speakership- 1 point</td>
                <td class="border border-black ">Regional Office Speakership - 1 point</td>
                <td class="border border-black ">Division/Provincial/City Level Speakership - 1 point</td>
                <td class="border border-black ">School/Municipality/District Speakership - 1 point</td>
            </tr>
...
<tr class="border-b border-gray-600 dark:border-gray-700">
    ...
    <td class="px-6 py-4">
        <?php echo e($this->applicationOfEducationWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category)); ?>
...
<tr class="border-b border-gray-600 dark:border-gray-700">
    ...
    <td class="px-2 py-4 bg-gray-50 dark:bg-gray-800" x-data="{ open: false }">
        ...
        <p class="max-w-[12rem] text-black" x-show="open" x-transition>
            ...
            <br>
               ...
               <table class="border-collapse border text-black border-black text-[.7rem]" x-show="open" x-transition>
            <tr>
                <td class="border border-black  ">All MOVs - Relevant (15pts); Not Relevant (9pts)</td>
            </tr>
            <tr>
                <td class="border border-black  ">Only A & B - Relevant (12pts) ; Not Relevant (6pts)</td>
            </tr>
            <tr>
                <td class="border border-black  ">Only A - Relevant (9pts); Not Relevant (3pts)</td>
            </tr>
    ...
    <td class="px-6 py-4">
        <input type="number" pattern="[0-9]" max="10" oninput="this.value = this.value.slice(0, 2)" required
            class="!w-[5rem]" x-model="application_of_education_attr.application_of_education_a" />
...
<tr class="border-b border-gray-600 dark:border-gray-700">
    ...
    <td class="px-6 py-4">
        <?php echo e($this->learningAndDevelopmentWeightAllocation($getRecord()->jobOtherInformation?->type, $getRecord()->jobOtherInformation?->category)); ?>
...
<?php /**PATH /home/loyd-deped/Desktop/www/PDS/resources/views/livewire/recruitment/assets/Related-Teaching Positions_SG 16-23 and SG-27.blade.php ENDPATH**/ ?>