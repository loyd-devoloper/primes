...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.link','data' => ['color' => 'danger','tabindex' => '-1','tag' => 'button','wire:click' => 'markAllNotificationsAsRead']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['color' => 'danger','tabindex' => '-1','tag' => 'button','wire:click' => 'markAllNotificationsAsRead']); ?>
...
<?php /**PATH /home/loyd-deped/Desktop/www/PDS/resources/views/vendor/filament-notifications/components/database/modal/actions.blade.php ENDPATH**/ ?>