...
@endassets
<x-assets.admin_layout target="callMountedTableAction,saveTemplate">
    <x-slot name="modal">
    ...
    @if (Auth::user()->fd_code == '01D' || Auth::user()->can(\App\Enums\UserManagement\PermissionEnum::GENERATING_ID->value))
        <div class="grid grid-cols-1 gap-4 " x-data="template(@entangle('attributesData'))">
            ...
            <div class="col-span-1">
                ...
                {{ $this->modalSelectAction }}
                {{ $this->modalDirectorAction }}
                    ...
                    <div class="">
                        ...
                        <x-filament::section>
                            <div class="grid grid-cols-3 gap-2">
                                <div>
                                    <label for="" class="dark:text-white">Select FontSize</label>
                                ...
                                <div>
                                    <label for="" class="dark:text-white">Select Color</label>
                                    <x-filament::input.wrapper>
                                ...
                                <div class="flex items-end">
                                    ...
                                    <label for="checkbox" class="py-2 px-4 rounded  "
                                        :class='textWeight ? "bg-blue-500" :
                                            "bg-transparent dark:text-white border border-blue-500"'>
                                        B
                                    </label>
        ...
        {{-- id container --}}
        <div wire:ignore id="my-node" class="w-[319.5px] h-[1015px] mx-auto bg-gray-100  relative" style="">
            ...
            <div class="relative   bg-green-500 ">
                @if (!!$activeTemplate)
                    @if (!!$activeTemplateData->front)
                        ...
                        <p class="absolute   z-[99] hidden text-left break-words" id='lastname_f'>COLON</p>
            ...
            <div class="relative   bg-green-500 ">
                @if (!!$activeTemplate)
                    @if (!!$activeTemplateData->back)
                        ...
                        <span class="absolute    z-[99] hidden text-center break-words" id='fullname_b'>JOHNLOYD
                            P.
                            COLON</span>

                        <span class="absolute   z-[99] text-center hidden leading-none  break-words"
                            id='emergency_b'>Rhian
                            colon <br> 09101421073</span>
