...
{{--        <button  class="bg-gray-500 px-6 py-2">Generate PDF</button>--}}
        <x-filament::icon-button
            ...
            label="Print"
            color="secondary"
            type="button" x-on:click="generateMe()"
        />
        <div id="table" class="block w-fit  overflow-x-auto   mx-auto text-xs relative ">
            ...
            @foreach($data as $key => $value)
                <div class=" ">
                    ...
                    <p class="border-b border-black text-center font-bold mt-4">{{explode('--',$key)[1]}}</p>
                    ...
                    <div class="grid grid-cols-5 pt-5">
                        ...
                        <div class="col-span-3">
                            <p class="border-b border-black text-center font-bold">OCTOBER 2024</p>
                    ...
                    {{-- Content --}}
                    <div x-data="{employee: @js($value)}" class=" max-w-[29rem]  h-full pt-10" >
                        <table class="border-collapse w-full ">
                            <tr class="">
                                <td class="border border-black border-solid px-2.5 text-center" rowspan="2">Days</td>
                                <td class="border-y border-r border-black border-solid px-2.5 text-center" colspan="2">A.M.</td>
                                <td class="border-y border-r border-black border-solid px-2.5 text-center" colspan="2">P.M.</td>
                                <td class="border-y border-r border-black border-solid px-2.5 text-center" colspan="2">UNDERTIME</td>
                            </tr>
                            <tr class="">
                                <td class="border-b border-r border-black border-solid px-2.5 text-center">Arrival</td>
                                <td class="border-b border-r border-black border-solid px-2.5 text-center">Departure</td>
                                <td class="border-b border-r border-black border-solid px-2.5 text-center">Arrival</td>
                                <td class="border-b border-r border-black border-solid px-2.5 text-center">Departure</td>
                                <td class="border-b border-r border-black border-solid px-2.5 text-center">Hours</td>
                            ...
                            @foreach($value['data'] as $dateKey => $date)
                                ...
                                <tr x-data="{date: @js($date)}">
                                    <td class="border-l border-b border-black border-solid px-2.5 py-1  font-bold text-center whitespace-nowrap">
                                        {{explode('-',$dateKey)[1]}}
                                    </td>
                    ...
                    <div class="max-w-[29rem] ">
                        <p class="pb-12 pt-5">I certify on my honor that the above is a true and correct report of the hours of work performed, record of which was made daily at the time of arrival and departure from office.</p>
