...
<body style="margin: 0%;padding:0%;font-size:.6rem;position: relative">
    <div style="padding-bottom: .8rem;">
        <h1 style="background: #ffb866;position: absolute;top: -3rem; left: -2rem">(CTO)</h1>
    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black;">
        <thead>
            <tr>
                ...
                <th style="border: 1px solid black; padding: 8px;" colspan="4">CTO</th>
            ...
            @foreach ($leaveData as $leave)
                @if ($leave->start_date < \Carbon\Carbon::now())
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid black; padding: 8px;text-align: center">
                            {{ $leave->type == 'CTO' ? $leave?->w_pay : '' }}
                        </td>
                        <td style="border: 1px solid black; padding: 8px;text-align: center">
                            {{ $leave?->cto_balance }}
                        </td>
                        <td style="border: 1px solid black; padding: 8px;text-align: center">
                            {{ $leave->type == 'CTO' ? $leave?->w_o_pay : '' }}
                            </td>
