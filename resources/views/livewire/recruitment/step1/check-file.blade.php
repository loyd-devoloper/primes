                ...
                <div class="mt-6">
                    ...
                    <x-filament::section>
                       ...
                       <div class="grid gap-3">
                        @forelse ($jobs as $job)
                        <div class="flex items-center justify-between gap-3 text-sm font-semibold bg-gray-100/50 px-4 py-2 rounded-md">
                            <div  class="flex items-center gap-3 ">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="min-w-8 max-w-8 h-8 fill-[#FFCB23] text-yellow-600">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.75V12A2.25 2.25 0 0 1 4.5 9.75h15A2.25 2.25 0 0 1 21.75 12v.75m-8.69-6.44-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 6v12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9a2.25 2.25 0 0 0-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44Z" />
                                  </svg>
                                  {{ $job->job_title }}
                            </div>
                            <a href="{{ route('recruitment.step1.checkfile.checkfiletable',['job_title'=>urldecode($job->job_title), 'id' => $job->job_id]) }}" class="bg-gray-800 text-white text-xs px-4 py-2 rounded-2xl hover:bg-green-500">Open</a>
                        </div>
                        @empty
