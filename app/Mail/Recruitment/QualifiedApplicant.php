...
class QualifiedApplicant extends Mailable
{
    ...
    {
        return new Content(
            markdown: 'emails.recruitment.qualified_applicant',
            with:[
                'data' => $this->data,
                'job_title' => $this->job_title,
                'place_of_assignment' => $this->place_of_assignment,
                'time' =>Carbon::parse($this->data['jobOtherInformation']['initial_evaluation'])->format('h:i:s A'),
                'date' => Carbon::parse($this->data['jobOtherInformation']['initial_evaluation'])->format('M d, Y'),
